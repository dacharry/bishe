#define NGX_CONFIGURE " --prefix=/usr/local/nginx/ --add-module=../fastdfs-nginx-module-master/src/"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 5.4.0 20160609 (Ubuntu 5.4.0-6ubuntu1~16.04.11) "
#endif
